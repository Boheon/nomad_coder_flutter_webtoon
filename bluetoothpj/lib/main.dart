import 'package:bluetoothpj/screens/device_screen.dart';
    ...
    if (!_isScanning) {
      ...
      FlutterBluePlus.scanResults.listen((results) {
        ...
        for (var element in results) {
          if (element.device.platformName == targetDeviceName) {
            if (scanResultList.indexWhere(
                    (e) => e.device.remoteId == element.device.remoteId) <
                0) {
              //찾는 장치명이고 scanResultList에 등록된 적이 없는 장치라면 리스트에 추가
